...
class VerifyPhone : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        verifyBtn = findViewById(R.id.buttonNextVerify_phone)
        resendTV = findViewById(R.id.TextView_ResendOTP)
    ...
    //inner class to shift the cursor to the next edit text for otp
